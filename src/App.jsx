...
const DECKS = [
  ...
  },
  {
    ...
    // Bei diesem Stapel ist Englisch die Hilfssprache statt Deutsch, daher
    // wird das "exampleDe"-Feld (immer die Uebersetzung zum Beispielsatz)
    // hier durch "exampleEn" ersetzt - siehe exampleTranslationField unten.
    exampleTranslationField: "exampleEn",
    directions: [
      { id: "de-en", label: "Deutsch → Englisch", frontField: "de", backField: "en", ipaFrontField: "ipaDe", ipaBackField: "ipaEn" },
      { id: "en-de", label: "Englisch → Deutsch", frontField: "en", backField: "de", ipaFrontField: "ipaEn", ipaBackField: "ipaDe" },
    ],
    ...
    for (const dir of deck.directions) {
      cards.push(
        initCard({
          ...
          exampleDe: pair[deck.exampleTranslationField || "exampleDe"],
        })
      );
    }
  }
...
const DEFAULT_DAILY_NEW_LIMIT = 5; // Fallback, falls ein Stapel kein eigenes Limit setzt

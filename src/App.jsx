...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Zufällige Auswahl aus dem Pool noch nicht eingeführter Karten,
    // statt stur der Reihenfolge im Deck-Array (Lektion/Alphabet) zu folgen.
    // Beeinflusst nur, WELCHE Karten neu eingeführt werden - keine
    // Auswirkung auf bereits gespeicherten Lernfortschritt.
    const toIntroduce = shuffle(newPool).slice(0, newBudget);
